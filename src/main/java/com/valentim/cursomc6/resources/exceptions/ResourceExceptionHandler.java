package com.valentim.cursomc6.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(DataIntgrityException.class)
	public ResponseEntity<StandardError> dataIntegrity(DataIntgrityException e, HttpServletRequest request) {
